...
RDS projects. This small utility helps. An original non UTF-8 file is preserved with extension .bak after a conversion. 

## Usage
1. run `rb` in the directory
2. use the built `nonutf8` to convert 'non-UTF-8' files to UTF-8

If a file in different than UTF-8 encoding contains a valuable information in the encoding,
then use some other more powerful tool.